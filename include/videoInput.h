...
class videoInput{
	...
	public:
		...
		// pan-tilt-zoom combo
		bool setLogitechPTZ(int deviceID, int pan, int tilt, int zoom);
		bool getLogitechPTZ(int deviceID, int& pan, int& tilt, int& zoom);

		// camera exposure control, in ms
		bool setLogitechExposure(int deviceID, float exposureMS);
		bool getLogitechExposure(int deviceID, float& exposureMS);

		// if we want to play with any of the other settings specified in public property set
		bool setLogitechSetting(int deviceID, DWORD propID, void* propData, int propSize);
		bool getLogitechSetting(int deviceID, DWORD propID, void* propData, int propSize);
